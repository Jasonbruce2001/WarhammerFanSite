...
{
    public class CommentsAdmin : Controller
    {
        private readonly ApplicationDbContext _context;

        public CommentsAdmin(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StoryId,Content,DatePosted")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StoryId,Content,DatePosted")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
